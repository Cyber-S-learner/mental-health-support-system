...
<form
  ...
  className="flex flex-col gap-6 w-fit max-w-md mx-auto bg-white  rounded-2xl shadow-lg  px-15 py-15 "
>
  {error && (
  ...
  <button
    type="submit"
    className="w-fit px-3 py-3 bg-teal-600 text-black rounded-xl font-semibold  hover:bg-teal-700 transition-all duration-200 border border-indigo-500"
  >
    Sign Up
  </button>
</form>
